...
export default function ConversationsPage() {
  return (
    <Suspense fallback={<div className="flex h-screen items-center justify-center bg-[#F9FAFB] dark:bg-[#0D1117]"><Loader2 className="w-8 h-8 animate-spin text-[#22C55E]" /></div>}>
